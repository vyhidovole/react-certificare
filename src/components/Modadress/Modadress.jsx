...
export const ModAdress = ({ active, setActive }) => {
  ...
  return (
    ...
    <div
      className={active ? "ModAdress active scale-100 " : "ModAdress scale-0 "}
      ...
      <div
        ...
        <form
          ...
          <input
            ...
            name="name" />
          <label
            className="pl-1" for="POST-adress">
            Адрес:
          </label>
          <textarea
            className="mb-6 w-44 ml-3 text-center" id="POST-name"
            rows="4"
            placeholder="Адрес доставки">
          </textarea>
          <input 
          
            className="pl-1" type="submit" value="Отправить" />
